        ...
        subMenu: [
            {
                subName: '',
                items: [
                    { name: 'Microsoft Azure', url: routesMap.MicrosoftAzure },
                    { name: 'Databricks', url: routesMap.DatabricksPage },
                    { name: 'Snowflake', url: routesMap.SnowflakePage },
                    { name: 'Holistic AI', url: routesMap.HolisticAIPage },
                    { name: 'Ataccama', url: routesMap.AtaccamaPage },
                ],
            },
        ]
    },
