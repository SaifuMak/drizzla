...
const DataAnalytics = () => {
  ...
  useEffect(() => {
      document.title = "Data Analytics | Drizzla"; // Force title change
  ...
  return (
    <>
      ...
      <HelmetComponent
        ...
        description="Leverage our data analytics solutions to make informed business decisions and drive growth."
      />
