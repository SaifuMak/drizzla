                ...
                <div className="flex justify-center ">
                    <div className="my-2 xl:space-y-24 2xl:space-y-32">
                        {GovernmentData?.map((data, index) => {
                            const governmentContentCardRef = useGsapFadeIn(0, { initialPosition: 50, duration: 1, start: "top 65%" })
                            const governmentImageCardRef = useGsapFadeIn(0, { initialPosition: 50, duration: 1, start: "top 70%" })
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div ref={governmentImageCardRef} className={` hidden-text  bg-slate-900    2xl:w-[540px] 2xl:h-[450px] xl:w-[450px] xl:h-[400px] lg:w-[380px] lg:h-[350px] md:w-[320px] md:h-[280px]  w-full     rounded-3xl ${index % 2 !== 0 ? "md:order-1 md:mr-10  lg:mr-16" : "md:order-2 md:ml-10 lg:ml-16"}`}>
