    ...
    <div className="flex-col flex-center">
      ...
      <div className="flex flex-col w-11/12 text-white 2xl:w-10/12 ">
        ...
        <div className="mt-20 2xl:mt-32 xl:mt-28">
          ...
          <ProductsOverview index={0} url={routesMap.CustomerService} containerClass='bg-custom-brown hover:bg-custom-hover-brown' title='Customer Service AI Co-Pilot' description='Empower your customer service team with AI-driven insights and supercharge their efficiency, leading to happier customers and more productive agents' number='/01' />
          <ProductsOverview index={1} url={routesMap.ContractLifecycle} containerClass='bg-custom-navy-blue hover:bg-custom-hover-navy-blue' title='Contract Lifecycle AI Co-Pilot' description='From creation to renewal, our AI co-pilot simplifies every stage of contract management, automating tedious tasks , ensuring compliance and freeing up your team for strategic work.' number='/02' />
